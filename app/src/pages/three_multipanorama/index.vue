...
export default defineComponent({
  setup() {
    ...
    const panoramas = {
      panorama1: {
        tilesPath: '/multipanorama/panorama_1',
        nextPanorama: 'panorama2',
        buttonPosition: new THREE.Vector3(20, -8, 0)
      },
      panorama2: {
        tilesPath: '/multipanorama/panorama_2',
    ...
    const isTileVisible = (x, y, level) => {
      ...
      return direction.dot(cameraDirection) > 0.05; // Увеличена область рендера
    };
